...
_renderImg = (imgType)=> {
        if (imgType == 'check') {
            return (
                <Image
                    style={{alignSelf:'center',height:38,width:38,marginBottom:20}}
                    source={require('./icon_check.png')}
                />
            )
        } else if (imgType == 'praise') {
            return (
                <Image
                    style={{alignSelf:'center',height:38,width:38,marginBottom:20}}
                    source={require('./icon_praise.png')}
                />
            )
        } else {
            return null;
    ...
    render() {
        ...
        >
            ...
            >
                ...
                >
                        {this._renderImg(this.props.imgType)}
